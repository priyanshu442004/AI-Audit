...
const COL_GROUPS = [
  ...
  { label: 'Invoice Information', cols: ['AP Invoice No.', 'Invoice Date', 'AP Credit Note No.'] },
  { label: 'Vendor Details',    cols: ['PO Number', 'Vendor Code', 'Vendor Name', 'Vendor Country'] },
  { label: 'Value',             cols: ['Items', 'Invoice Value (INR)'] },
...
// ---------------------------------------------------------------------------
const MOCK_ROWS = [
  { 'GRN No.': '490001201', 'GRN Date': '03/04/25', 'AP Invoice No.': 'INV-TT-20250001', 'Invoice Date': '05/04/25', 'PO Number': '4500089123', 'AP Credit Note No.': '—',              'Vendor Code': 'V001', 'Vendor Name': 'Tata Steel Ltd',             'Vendor Country': 'India',   'Items': 4, 'Invoice Value (INR)': 245800,  'Days GRN→Inv':   2, 'Within 7-day SLA': true,  'Invoice > 7 days (Breach)': false, 'Seq Exception (Inv<GRN)': false },
  { 'GRN No.': '490001202', 'GRN Date': '05/04/25', 'AP Invoice No.': 'INV-BO-20250002', 'Invoice Date': '07/04/25', 'PO Number': '4500089124', 'AP Credit Note No.': '—',              'Vendor Code': 'V002', 'Vendor Name': 'Bosch Limited',               'Vendor Country': 'Germany', 'Items': 2, 'Invoice Value (INR)':  89450,  'Days GRN→Inv':   2, 'Within 7-day SLA': true,  'Invoice > 7 days (Breach)': false, 'Seq Exception (Inv<GRN)': false },
  { 'GRN No.': '490001203', 'GRN Date': '07/04/25', 'AP Invoice No.': 'INV-MR-20250003', 'Invoice Date': '15/04/25', 'PO Number': '4500089125', 'AP Credit Note No.': '—',              'Vendor Code': 'V003', 'Vendor Name': 'Maruti Suzuki Industries',     'Vendor Country': 'India',   'Items': 6, 'Invoice Value (INR)': 412700,  'Days GRN→Inv':   8, 'Within 7-day SLA': false, 'Invoice > 7 days (Breach)': true,  'Seq Exception (Inv<GRN)': false },
  { 'GRN No.': '490001204', 'GRN Date': '11/04/25', 'AP Invoice No.': 'INV-AB-20250004', 'Invoice Date': '22/05/25', 'PO Number': '4500089126', 'AP Credit Note No.': '—',              'Vendor Code': 'V004', 'Vendor Name': 'ABB India Limited',             'Vendor Country': 'India',   'Items': 3, 'Invoice Value (INR)': 178200,  'Days GRN→Inv':  41, 'Within 7-day SLA': false, 'Invoice > 7 days (Breach)': true,  'Seq Exception (Inv<GRN)': false },
  { 'GRN No.': '490001205', 'GRN Date': '09/04/25', 'AP Invoice No.': 'INV-HV-20250005', 'Invoice Date': '10/04/25', 'PO Number': '4500089127', 'AP Credit Note No.': '—',              'Vendor Code': 'V005', 'Vendor Name': 'Havells India Ltd',             'Vendor Country': 'India',   'Items': 1, 'Invoice Value (INR)':  56300,  'Days GRN→Inv':   1, 'Within 7-day SLA': true,  'Invoice > 7 days (Breach)': false, 'Seq Exception (Inv<GRN)': false },
  { 'GRN No.': '490001206', 'GRN Date': '10/04/25', 'AP Invoice No.': 'INV-BF-20250006', 'Invoice Date': '11/04/25', 'PO Number': '4500089128', 'AP Credit Note No.': 'CN-BF-20250001', 'Vendor Code': 'V006', 'Vendor Name': 'BASF India Limited',           'Vendor Country': 'Germany', 'Items': 8, 'Invoice Value (INR)': 523100,  'Days GRN→Inv':   1, 'Within 7-day SLA': true,  'Invoice > 7 days (Breach)': false, 'Seq Exception (Inv<GRN)': false },
  { 'GRN No.': '490001207', 'GRN Date': '12/04/25', 'AP Invoice No.': 'INV-SI-20250007', 'Invoice Date': '30/05/25', 'PO Number': '4500089129', 'AP Credit Note No.': '—',              'Vendor Code': 'V007', 'Vendor Name': 'Siemens Limited',               'Vendor Country': 'Germany', 'Items': 5, 'Invoice Value (INR)': 310500,  'Days GRN→Inv':  48, 'Within 7-day SLA': false, 'Invoice > 7 days (Breach)': true,  'Seq Exception (Inv<GRN)': false },
  { 'GRN No.': '490001208', 'GRN Date': '14/04/25', 'AP Invoice No.': 'INV-MT-20250008', 'Invoice Date': '14/04/25', 'PO Number': '4500089130', 'AP Credit Note No.': '—',              'Vendor Code': 'V008', 'Vendor Name': 'Mitsubishi Electric India',     'Vendor Country': 'Japan',   'Items': 2, 'Invoice Value (INR)': 195400,  'Days GRN→Inv':   0, 'Within 7-day SLA': true,  'Invoice > 7 days (Breach)': false, 'Seq Exception (Inv<GRN)': false },
  { 'GRN No.': '490001209', 'GRN Date': '24/04/25', 'AP Invoice No.': 'INV-PN-20250009', 'Invoice Date': '18/06/25', 'PO Number': '4500089131', 'AP Credit Note No.': '—',              'Vendor Code': 'V009', 'Vendor Name': 'Panasonic India Pvt Ltd',       'Vendor Country': 'Japan',   'Items': 3, 'Invoice Value (INR)':  87600,  'Days GRN→Inv':  55, 'Within 7-day SLA': false, 'Invoice > 7 days (Breach)': true,  'Seq Exception (Inv<GRN)': false },
  { 'GRN No.': '490001210', 'GRN Date': '17/04/25', 'AP Invoice No.': 'INV-SC-20250010', 'Invoice Date': '19/04/25', 'PO Number': '4500089132', 'AP Credit Note No.': '—',              'Vendor Code': 'V010', 'Vendor Name': 'Schneider Electric India',       'Vendor Country': 'France',  'Items': 7, 'Invoice Value (INR)': 629400,  'Days GRN→Inv':   2, 'Within 7-day SLA': true,  'Invoice > 7 days (Breach)': false, 'Seq Exception (Inv<GRN)': false },
  { 'GRN No.': '490001211', 'GRN Date': '17/04/25', 'AP Invoice No.': 'INV-DL-20250011', 'Invoice Date': '25/04/25', 'PO Number': '4500089133', 'AP Credit Note No.': '—',              'Vendor Code': 'V011', 'Vendor Name': 'Delta Electronics India',       'Vendor Country': 'China',   'Items': 4, 'Invoice Value (INR)': 142300,  'Days GRN→Inv':   8, 'Within 7-day SLA': false, 'Invoice > 7 days (Breach)': true,  'Seq Exception (Inv<GRN)': false },
  { 'GRN No.': '490001212', 'GRN Date': '19/04/25', 'AP Invoice No.': 'INV-HN-20250012', 'Invoice Date': '03/06/25', 'PO Number': '4500089134', 'AP Credit Note No.': 'CN-HN-20250001', 'Vendor Code': 'V012', 'Vendor Name': 'Honeywell Automation India',   'Vendor Country': 'USA',     'Items': 2, 'Invoice Value (INR)': 315800,  'Days GRN→Inv':  45, 'Within 7-day SLA': false, 'Invoice > 7 days (Breach)': true,  'Seq Exception (Inv<GRN)': false },
  { 'GRN No.': '490001213', 'GRN Date': '22/04/25', 'AP Invoice No.': 'INV-TT-20250013', 'Invoice Date': '25/04/25', 'PO Number': '4500089135', 'AP Credit Note No.': '—',              'Vendor Code': 'V001', 'Vendor Name': 'Tata Steel Ltd',                 'Vendor Country': 'India',   'Items': 5, 'Invoice Value (INR)': 387600,  'Days GRN→Inv':   3, 'Within 7-day SLA': true,  'Invoice > 7 days (Breach)': false, 'Seq Exception (Inv<GRN)': false },
  { 'GRN No.': '490001214', 'GRN Date': '24/04/25', 'AP Invoice No.': 'INV-BO-20250014', 'Invoice Date': '26/04/25', 'PO Number': '4500089136', 'AP Credit Note No.': '—',              'Vendor Code': 'V002', 'Vendor Name': 'Bosch Limited',                   'Vendor Country': 'Germany', 'Items': 3, 'Invoice Value (INR)': 128700,  'Days GRN→Inv':   2, 'Within 7-day SLA': true,  'Invoice > 7 days (Breach)': false, 'Seq Exception (Inv<GRN)': false },
  { 'GRN No.': '490001215', 'GRN Date': '24/04/25', 'AP Invoice No.': 'INV-AB-20250015', 'Invoice Date': '30/04/25', 'PO Number': '4500089137', 'AP Credit Note No.': '—',              'Vendor Code': 'V004', 'Vendor Name': 'ABB India Limited',               'Vendor Country': 'India',   'Items': 6, 'Invoice Value (INR)': 278900,  'Days GRN→Inv':   6, 'Within 7-day SLA': true,  'Invoice > 7 days (Breach)': false, 'Seq Exception (Inv<GRN)': false },
  { 'GRN No.': '490001216', 'GRN Date': '22/06/25', 'AP Invoice No.': 'INV-SI-20250016', 'Invoice Date': '21/06/25', 'PO Number': '4500089138', 'AP Credit Note No.': '—',              'Vendor Code': 'V007', 'Vendor Name': 'Siemens Limited',                 'Vendor Country': 'Germany', 'Items': 1, 'Invoice Value (INR)':  94200,  'Days GRN→Inv':  -1, 'Within 7-day SLA': false, 'Invoice > 7 days (Breach)': false, 'Seq Exception (Inv<GRN)': true  },
  { 'GRN No.': '490001217', 'GRN Date': '28/04/25', 'AP Invoice No.': 'INV-MR-20250017', 'Invoice Date': '10/04/25', 'PO Number': '4500089139', 'AP Credit Note No.': '—',              'Vendor Code': 'V003', 'Vendor Name': 'Maruti Suzuki Industries',         'Vendor Country': 'India',   'Items': 2, 'Invoice Value (INR)': 156400,  'Days GRN→Inv': -18, 'Within 7-day SLA': false, 'Invoice > 7 days (Breach)': false, 'Seq Exception (Inv<GRN)': true  },
  { 'GRN No.': '490001218', 'GRN Date': '28/04/25', 'AP Invoice No.': 'INV-HV-20250018', 'Invoice Date': '15/05/25', 'PO Number': '4500089140', 'AP Credit Note No.': 'CN-HV-20250002', 'Vendor Code': 'V005', 'Vendor Name': 'Havells India Ltd',               'Vendor Country': 'India',   'Items': 4, 'Invoice Value (INR)':  89300,  'Days GRN→Inv':  17, 'Within 7-day SLA': false, 'Invoice > 7 days (Breach)': true,  'Seq Exception (Inv<GRN)': false },
]
...
export default function GrnToAp({ data }) {
  ...
  const kpiCards = [
    ...
    { label: 'Unique AP Credit Notes',          value: k('unique_ap_credit_notes'), accent: 'blue',  desc: 'Distinct AP credit notes identified in the period' },
