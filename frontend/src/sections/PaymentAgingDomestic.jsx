...
import { fetchPaymentAgingDomestic } from '../api'
...
export default function PaymentAgingDomestic() {
  ...
  }, [paymentAgingDomestic, setPaymentAgingDomestic])
  ...
  const rows = paymentAgingDomestic?.rows || []
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">
          Processing Domestic Payment Aging analysis...
        </p>
      </div>
    )
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-5 shadow-sm flex flex-col justify-between">
          <div>
            <h3 className="text-sm font-bold text-slate-900 dark:text-white">Domestic Status Distribution</h3>
        ...
        <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-800 flex flex-col gap-3">
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">Detail level aging status for each domestic ledger transaction</p>
            </div>
