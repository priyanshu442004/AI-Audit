...
import { fetchPaymentAgingRelated } from '../api'
...
export default function PaymentAgingRelated() {
  ...
  }, [paymentAgingRelated, setPaymentAgingRelated])
  ...
  const rows = paymentAgingRelated?.rows || []
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">
          Processing Related Party Payment Aging analysis...
        </p>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      ...
      {/* AI Insight Box */}
      <AiInsightBox section="paymentagingrelated" kpis={{
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-5 shadow-sm">
          <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-3">Top 5 Overdue Related Parties</h3>
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs border-collapse">
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800 font-medium">
                ...
                {topOverdue.length === 0 && (
                  <tr>
                    <td colSpan={5} className="py-4 text-center text-slate-400">No overdue related parties found</td>
                  </tr>
                )}
              </tbody>
            </table>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-5 shadow-sm flex flex-col justify-between">
          <div>
            <h3 className="text-sm font-bold text-slate-900 dark:text-white">Related Party Status Distribution</h3>
        ...
        <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-800 flex flex-col gap-3">
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">Detail level aging status for each related party ledger transaction</p>
            </div>
