...
export default function PriceVarianceSame() {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">
          Processing same-vendor price variance analysis...
        </p>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      ...
      {/* AI Insight Box */}
      <AiInsightBox section="pricevariancesame" kpis={{
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
        ...
        <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-800 flex flex-col gap-3">
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div>
              <h3 className="text-sm font-bold text-slate-900 dark:text-white">Vendor Pricing Inconsistencies</h3>
              <p className="text-xs text-slate-400 mt-0.5">Lines grouped by vendor, showcasing PO, GRN, and Unit Rate stats</p>
            </div>
