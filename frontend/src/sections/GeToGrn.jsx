...
export default function GeToGrn({ data }) {
  ...
  const kpiCards = [
    ...
    { label: 'Sequence Exceptions (GRN < GE)',    value: k('sequence_exceptions'),    accent: (k('sequence_exceptions') ?? 0) > 0 ? 'rose' : 'blue', desc: 'Cases where GRN date precedes Gate Entry date' },
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
        ...
        <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-800 flex flex-col gap-3">
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div>
              <h3 className="text-sm font-bold text-slate-900 dark:text-white">GE to GRN Full Reconciliation List</h3>
